...
static NSString *SegueFiltersToMain = @"SegueFiltersToMain";
...
-(void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender{
    if([segue.identifier isEqualToString:SegueFiltersToMain]){
        ViewController *vc = segue.destinationViewController;
        NSNumber *filterNumber = (NSNumber*)sender;
        vc.filterType = (GPUImageShowcaseFilterType)filterNumber.unsignedIntegerValue;
    }
}
...
//    [self.navigationController pushViewController:filterViewController animated:YES];
    [self performSegueWithIdentifier:SegueFiltersToMain sender:@((GPUImageShowcaseFilterType)indexPath.row)];
}
